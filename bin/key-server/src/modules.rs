        ...
        tokio::task::spawn_blocking(move || {
            ...
            while let Some(command) = rx.blocking_recv() {
                match command {
                    ...
                    HidCommand::HoldSpecial(special) => hid.hold_special(special as u32),
                    HidCommand::HoldModifier(modifier) => hid.hold_modifier(modifier as u32),
                    HidCommand::ReleaseKey(key) => hid.release_key(key as u32),
                    HidCommand::ReleaseSpecial(special) => hid.release_special(special as u32),
                    HidCommand::ReleaseModifier(modifier) => hid.release_modifier(modifier as u32),
                    ...
                    HidCommand::HoldButton(button) => hid.hold_button(button as u32),
                    HidCommand::ReleaseButton(button) => hid.release_button(button as u32),
